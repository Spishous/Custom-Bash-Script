...
*/
const font_3d="3-d",
      font_alligator2="alligator2",
      font_bell="bell",
      font_big="big",
      font_block="block",
      font_contessa="contessa",
      font_cybermedium="cybermedium",
      font_epic="epic",
      font_isometric1="isometric1",
      font_larry3d="larry3d",
      font_rectangles="rectangles",
      font_script="script",
      font_slant="slant",
      font_small="small",
      font_smkeyboard="smkeyboard",
...
class Figlet
{
     ...
     */
    public function loadFont($filename=font_standard, $loadgerman = true)
    {
        $this->font = array();
        if(!file_exists($filename)) {
            if(file_exists(__DIR__."/fonts/".$filename.".flf")){
                $filename=__DIR__."/fonts/".$filename.".flf";
            }else{
                return false;
            }
    ...
    */
    public function getTextCharted($str, $inhtml = false)
    {
        if(!$this->font){
            $this->loadFont();
        }
